# -*- coding: utf-8 -*-
"""Data_Fetching_Image_Display.ipynb
...
#Used to get the coordinate points in the database that are near the given coordinate point index
...
# Creating a new database that only keeps points that are surrounded by other
# points to identify clusters as wildfires
